...
<?endif?>
<form name="iblock_add" action="<?=POST_FORM_ACTION_URI?>" method="post" enctype="multipart/form-data" class="comment-form">
	<?=bitrix_sessid_post()?>
			...
			<tr>
				<td colspan="2">
					...
					<?if (strlen($arParams["LIST_URL"]) > 0):?>
						<input type="submit" name="iblock_apply" value="Изменить" />
						<input
							type="button"
							name="iblock_cancel"
