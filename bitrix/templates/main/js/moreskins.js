CoolClock.config.skins = {
    ...
    "default": {
			outerBorder: { lineWidth: 4, radius:98, color: "#fff", alpha: 0 },
			smallIndicator: { lineWidth: 0, startAt: 0, endAt: 0, color: "#555", alpha: 0 },
			largeIndicator: { lineWidth: 0, startAt: 0, endAt: 0, color: "#555", alpha: 0 },
